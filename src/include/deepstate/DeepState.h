...
#define DEEPSTATE_READBYTE (DeepState_InputIndex < DeepState_InputInitialized ? DeepState_Input[DeepState_InputIndex++] : (!DeepState_InternalFuzzing ? (DeepState_InputIndex++, 0) :  (DeepState_InputIndex++, (char)rand())))
